def coin_count(handler, table_name):
    ...
    return '{} people tweeted about Ethereum in the past 24 hours. #eth #crypto'.format(eth_count), \
           '{} people tweeted about Bitcoin in the past 24 hours. #btc #crypto'.format(btc_count), \
           '{} people tweeted about Ripple in the past 24 hours. #btc #crypto'.format(xrp_count)
